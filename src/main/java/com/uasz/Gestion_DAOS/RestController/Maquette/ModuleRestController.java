...
public class ModuleRestController {
    ...
    // Details Module pour enseignement
    @GetMapping(path = "/moduleDetailsEnseignement/{id}")
    public List<Enseignement> detailsModuleEnseignement(@PathVariable Long id) {
        return moduleService.detailsModuleEnseignement(id);
    }
}