package com.uasz.Gestion_DAOS_EmploiDuTemps.RepartitionService.Service;
...
import
com.uasz.Gestion_DAOS_EmploiDuTemps.RepartitionService.RepartitionRepository;
...
// Repartition repartitionModifier =
// rechercherRepartition(repartition.getId());
// if (repartitionModifier != null) {
